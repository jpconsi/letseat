...
import com.considine.letseat.DistanceDetailActivity;
import com.considine.letseat.DistanceListActivity;
    ...
    public static void enableStrictMode() {
        ...
        if (Utils.hasGingerbread()) {
            ...
            if (Utils.hasHoneycomb()) {
                ...
                vmPolicyBuilder.setClassInstanceLimit(DistanceListActivity.class, 1)
                        .setClassInstanceLimit(DistanceDetailActivity.class, 1);
            }
